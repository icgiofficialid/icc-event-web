// ================================================================
// yicc.ts
// Path: src/config/events/yicc.ts
// Disesuaikan dengan Guidebook yicc 2026
// ================================================================

import type { EventDetailData } from "@/config/eventDetailTypes";

const yicc: EventDetailData = {
  slug: "yicc-2026",
  organizers: [
  ...
  email:   "iccfofficial.icgi@gmail.com",
  website: "iccofficial.or.id",
  venue:   "Yogyakarta, Indonesia",

  labels: {
    eventBadge:    { en: "ICC · yicc Competition 2026",             id: "ICC · Kompetisi 2026" },
    heroBadge:     { en: "Competition · Denpasar, Yogyakarta",        id: "Kompetisi · Denpasar, Yogyakarta" },
    categoriesDesc: {
    ...
    scheduleDesc: {
      en: "yicc 2026 takes place from September 16–20, 2026 across 5 days of competition, judging, cultural exchange, and awarding ceremony.",
      id: "yicc 2026 berlangsung pada 16–20 September 2026 selama 5 hari yang mencakup kompetisi, penjurian, pertukaran budaya, dan upacara penghargaan.",
    },
  },
...
about: {
  welcome: {
    en: "Yogyakarta International Engineering Science Fair (BIESF) is an international science competition will be held for the first time in Yogyakarta as a platform for students to showcase their innovations, research, and projects in the fields of science, technology, and engineering, while fostering global collaboration and the development of critical and creative thinking skills. The event will take place from September 16–20, 2026, with a series of activities including the Opening Ceremony & Judging Session Day 1 (September 16, 2026), Judging Session Day 2 (September 17, 2026), Private Judging Session (Selective) and Afternoon Tea & Cultural Exchange (September 18, 2026), Awarding Ceremony (September 19, 2026), and FunEdu Trip (September 20, 2026).",
    id: "Yogyakarta International Engineering Science Fair (BIESF) adalah kompetisi sains internasional yang akan diselenggarakan untuk pertama kalinya di Yogyakarta sebagai platform bagi pelajar untuk memamerkan inovasi, penelitian, dan proyek di bidang sains, teknologi, dan rekayasa, sekaligus mendorong kolaborasi global dan pengembangan keterampilan berpikir kritis dan kreatif. Acara ini akan berlangsung dari 16–20 September 2026, dengan serangkaian kegiatan termasuk Upacara Pembukaan & Sesi Penjurian Hari 1 (16 September 2026), Sesi Penjurian Hari 2 (17 September 2026), Sesi Penjurian Privat (Selektif) dan Afternoon Tea & Pertukaran Budaya (18 September 2026), Upacara Penghargaan (19 September 2026), dan FunEdu Trip (20 September 2026).",
  },
  background: {
  ...
  scheduleOffline: [
      {
        day: 1,
        date: { en: "September 16th, 2026", id: "16 September 2026" },
        title: { en: "Opening Ceremony & Judging Session Day 1", id: "Upacara Pembukaan & Sesi Penilaian Hari 1" },
        items: [
          { time: "08:00 AM – 09:00 AM", description: { en: "Opening Ceremony for Offline Participants",  id: "Upacara Pembukaan untuk Peserta Offline" }, location: { en: "Denpasar, Yogyakarta", id: "Denpasar, Yogyakarta" } },
          { time: "10:00 AM – 04:00 PM", description: { en: "Offline Judging Session Day 1",              id: "Sesi Penilaian Offline Hari 1" },            location: { en: "Denpasar, Yogyakarta", id: "Denpasar, Yogyakarta" } },
        ],
      },
      {
        day: 2,
        date: { en: "September 17th, 2026", id: "17 September 2026" },
        title: { en: "Judging Session Day 2 (Tentative)", id: "Sesi Penilaian Hari 2 (Tentatif)" },
        items: [
          { time: "10:00 AM – 04:00 PM", description: { en: "Offline Judging Session Day 2 (Tentative)", id: "Sesi Penilaian Offline Hari 2 (Tentatif)" }, location: { en: "Denpasar, Yogyakarta", id: "Denpasar, Yogyakarta" } },
        ],
      },
      {
        day: 3,
        date: { en: "September 18th, 2026", id: "18 September 2026" },
        title: { en: "Private Judging & Cultural Exchange", id: "Private Judging & Pertukaran Budaya" },
        items: [
          { time: "08:00 AM – 11:00 AM", description: { en: "Private Judging Session for Offline Participants", id: "Sesi Private Judging untuk Peserta Offline" }, location: { en: "Denpasar, Yogyakarta", id: "Denpasar, Yogyakarta" } },
          { time: "03:00 PM – 06:00 PM", description: { en: "Afternoon Tea & Cultural Exchange",               id: "Afternoon Tea & Pertukaran Budaya" },          location: { en: "Denpasar, Yogyakarta", id: "Denpasar, Yogyakarta" } },
        ],
      },
      {
        day: 4,
        date: { en: "September 19th, 2026", id: "19 September 2026" },
        title: { en: "Awarding Ceremony & Closing", id: "Upacara Penghargaan & Penutupan" },
        items: [
          { time: "10:00 AM – Finish", description: { en: "Awarding Ceremony for Offline Participants", id: "Upacara Penghargaan untuk Peserta Offline" }, location: { en: "Denpasar, Yogyakarta", id: "Denpasar, Yogyakarta" } },
        ],
      },
      {
        day: 5,
        date: { en: "September 20th, 2026", id: "20 September 2026" },
        title: { en: "FunEdu Trip (Optional)", id: "FunEdu Trip (Opsional)" },
        items: [
          { time: "07:00 AM – Finish", description: { en: "FunEdu Trip for Offline Participants", id: "FunEdu Trip untuk Peserta Offline" }, location: { en: "Yogyakarta", id: "Yogyakarta" } },
        ],
      },
    ],
    ...
    scheduleOnline: [
      {
        day: 1,
        date: { en: "September 25th, 2026", id: "25 September 2026" },
        title: { en: "Opening Ceremony & Judging Session Day 1", id: "Upacara Pembukaan & Sesi Penilaian Hari 1" },
        items: [
      ...
      {
        day: 2,
        date: { en: "September 26th, 2026", id: "26 September 2026" },
      ...
      {
        day: 3,
        date: { en: "September 27th, 2026", id: "27 September 2026" },
